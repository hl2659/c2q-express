...
public class TemporalNormalize {
	...
	public TemporalNormalize() {
		...
		String sutimeRules="edu/columbia/dbmi/cwlab/models/defs.sutime.txt,"+"edu/columbia/dbmi/cwlab/models/english.holidays.sutime.txt,"+"edu/columbia/dbmi/cwlab/models/english.sutime.txt";
	...
	public String batchTemporalNormalize(String[] temporal){
		StringBuffer sb=new StringBuffer();
		for(String t:temporal){
			Integer days=temporalNormalizeforNumberUnit(t);
			sb.append(t+"\t"+days+"\n");
		}
		return sb.toString();
	}
