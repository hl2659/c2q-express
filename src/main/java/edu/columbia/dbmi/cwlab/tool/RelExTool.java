...
//		}
	...
	public  <T> T readModel(String modelName) {
...
//	    		File f = new File(realPath.getPath()+"/"+modelName);
			InputStream in = new BufferedInputStream(new FileInputStream(modelName));
			this.getClass().getClassLoader().getResourceAsStream(modelName);
